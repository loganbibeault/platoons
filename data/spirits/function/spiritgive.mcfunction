...
execute as @a[scores={customspurchase=12,spiritcount=1..}] at @s run give @s dragon_breath[enchantment_glint_override=1b,custom_name=[{"italic":false,"text":"I","color":"#29BAFF"},{"text":"n","color":"#52D4D9"},{"text":"s","color":"#56EE9E"},{"text":"t","color":"#63F58E"},{"text":"a","color":"#7FEF70"},{"text":"n","color":"#d6fa82"},{"text":"t","color":"#EEE677"},{"text":" S","color":"#EECE7A"},{"text":"t","color":"#E6B770"},{"text":"i","color":"#DE8F65"},{"text":"m","color":"#D7805B"},{"text":"u","color":"#CF6F52"},{"text":"l","color":"#C75648"},{"text":"a","color":"#BF4240"},{"text":"n","color":"#bf405e"},{"text":"t","color":"#bf4084"}],max_stack_size=4,consumable={consume_seconds:0,animation:"drink",has_consume_particles:false,on_consume_effects:[{type:"minecraft:apply_effects",effects:[{id:"minecraft:instant_health",amplifier:1,duration:20,show_particles:0b,show_icon:0b},{id:"minecraft:saturation",amplifier:1,duration:120,show_particles:0b,show_icon:0b},{id:"minecraft:speed",amplifier:0,duration:200,show_particles:1b,show_icon:1b}]},{type:"minecraft:play_sound",sound:"entity.experience_orb.pickup"}]}] 1
