...
execute at @s[team=Tier1] run setblock ~ ~ ~ oxidized_copper_chest{LootTable:"platoons:chests/tier/1",CustomName:[{"text":"Tier 1 Lootbox","color":"dark_aqua"}]} destroy
...
execute at @s[team=Tier2] run setblock ~ ~ ~ oxidized_copper_chest{LootTable:"platoons:chests/tier/2",CustomName:[{"text":"Tier 2 Lootbox","color":"#1fa31f"}]} destroy
...
execute at @s[team=Tier3] run setblock ~ ~ ~ oxidized_copper_chest{LootTable:"platoons:chests/tier/3",CustomName:[{"text":"Tier 3 Lootbox","color":"#bd9017"}]} destroy
...
execute at @s[team=Tier4] run setblock ~ ~ ~ oxidized_copper_chest{LootTable:"platoons:chests/tier/4",CustomName:[{"text":"Tier 4 Lootbox","color":"#ba580d"}]} destroy
...
execute at @s[team=Tier5] run setblock ~ ~ ~ oxidized_copper_chest{LootTable:"platoons:chests/tier/5",CustomName:[{"text":"Tier 5 Lootbox","color":"#911023"}]} destroy
