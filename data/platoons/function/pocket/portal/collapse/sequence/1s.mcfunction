...
execute at @e[tag=pocket_exit] run title @a[distance=0..] title {"text":"1","color":"#B88BD6"}
schedule function platoons:pocket/portal/collapse/begin 1s
schedule function platoons:pocket/portal/collapse/final 16s