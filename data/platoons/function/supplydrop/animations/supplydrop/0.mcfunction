...
execute at @n[type=item_display,tag=supplydrop] run playsound minecraft:block.note_block.bit master @a[distance=0..55] ~ ~ ~ 0.6 1.06 0.05
execute at @n[type=item_display,tag=supplydrop] run playsound minecraft:block.note_block.bass master @a[distance=0..55] ~ ~ ~ 0.8 1.06 0.05
